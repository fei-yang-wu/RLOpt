#!/usr/bin/env python
"""Train Info-GAIL with expert demonstrations."""
...
from rlopt.agent.imitation import InfoGAIL, InfoGAILRLOptConfig
...
def train_infogail(
    ...
    Args:
        ...
        skill_dim: Dimensionality of skill embeddings
        mi_coefficient: Weight for mutual information term

    Returns:
        Trained Info-GAIL agent
    """
    print("=" * 70)
    print("Info-Info-GAIL Training with Expert Demonstrations")
    print("=" * 70)
    ...
    # Configure Info-GAIL
    print("\n" + "=" * 70)
    print("Configuring Info-GAIL")
    print("=" * 70)

    cfg = InfoGAILRLOptConfig()
    ...
    # Initialize Info-GAIL
    print("\n" + "=" * 70)
    print("Initializing Info-GAIL")
    print("=" * 70)

    agent = InfoGAIL(env=env, config=cfg)
    ...
    # Train
    print("\n" + "=" * 70)
    print("Training Info-GAIL")
    print("=" * 70)
    print("\nInfo-GAIL will learn:")
    print("  1. Skill embeddings for diverse behaviors")
    print("  2. Skill-conditioned discriminator")
    print("  3. Policy to maximize GAIL reward + MI bonus")
    print()
    ...
    if len(agent.episode_rewards) > 0:
        ...
        # Save model
        save_path = agent._logging_manager.run_dir / "infogail_model.pt"
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="Dimensionality of skill embeddings (default: 8)",
    )
    parser.add_argument(
        "--mi-coeff",
        type=float,
        default=0.1,
        help="Weight for mutual information term (default: 0.1)",
    )
