#!/usr/bin/env python
"""Train ASE with expert demonstrations."""
...
from rlopt.agent.imitation import ASE, ASERLOptConfig
...
def train_ase(
    ...
    """
    print("=" * 70)
    print("Info-ASE Training with Expert Demonstrations")
    print("=" * 70)
    ...
    # Initialize ASE
    print("\n" + "=" * 70)
    print("Initializing ASE")
    print("=" * 70)

    agent = ASE(env=env, config=cfg)
    ...
    if len(agent.episode_rewards) > 0:
        ...
        # Save model
        save_path = agent._logging_manager.run_dir / "ase_model.pt"
